...
@endpush
<div>
    <x-slot name="title">SALE RETURN LIST</x-slot>
    <x-slot name="header">SALE RETURN LIST</x-slot>
    <div class="row mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title mb-3">Sale Return List</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                            <div class="text-sm-right">
                                <a href="{{ route('inventory.sale-return') }}">
                        ...
                        <div wire:ignore class="table-responsive">
                            <table class="display table table-striped table-bordered" id="SaleReturnListTable"
                        ...
                        <div>
                            ...
                            <div id="invoice_page">
                                    ...
                                    <div style="overflow:hidden;">
                                        <div style="float:left;margin-top:0px;width: 74%;">
                                            <div class="row">
                                                <div style="float:left;width: 25%;">
                                                    <span><img height=60px; width=100px; src="@if ($invoice_setting){{ asset('storage/photo/' . $invoice_setting->logo) }}@endif"
                                                            alt=""></span>
                                                </div>
                                            ...
                                            <p style="font-size:13px;margin:0px;padding:0px; lightskyblue;font-weight:bold;">
                                                Bill To</p>
                                            <h6><strong>Customer Name @php echo str_repeat('&nbsp;', 5); @endphp:
                                                </strong><strong>@if ($invoice) {{ $invoice->Contact->name }}@endif</strong></h6>
                                            <h6><strong>Contact Person
                                                    @php echo str_repeat('&nbsp;',6); @endphp:</strong><strong>@if ($invoice) {{ $invoice->Contact->business_name }}@endif</strong>
                                            </h6>
                                            <h6><strong>Telephone
                                                    @php echo str_repeat('&nbsp;', 14); @endphp:</strong><strong>@if ($invoice) {{ $invoice->Contact->telephone }}@endif</strong>
                                            </h6>
                                            <h6><strong>Mobile
                                                    @php echo str_repeat('&nbsp;', 20); @endphp:</strong><strong>@if ($invoice) {{ $invoice->Contact->mobile }} @endif</strong>
                                            </h6>
                                            ...
                                            <h6><strong>Address @php echo str_repeat('&nbsp;', 18); @endphp:</strong>
                                                <strong>@if ($invoice) {{ $invoice->Contact->address }} @endif</strong> </h6>
                                        ...
                                        <div style="float:right;width: 25%;">
                                            ...
                                            <h6 style="margin:0px;font-weight:bold;font-size:20px;color:lightskyblue">
                                                Sales Return Invoice</h6>
                                            <h6><strong>Invoice No
                                                    @php echo str_repeat('&nbsp;',1); @endphp:</strong><strong>{{ $invoice->code }}</strong>
                                            </h6>
                                            <h6><strong>Date @php echo str_repeat('&nbsp;',10); @endphp:</strong>
                                                <strong>{{ date('Y/m/d') }}</strong></h6>
                                            <h6><strong>Chalan No
                                                    @php echo str_repeat('&nbsp;',1); @endphp:</strong><strong>{{ $invoice->chalan_no }}</strong>
                                            </h6>
                                            <h6><strong>Memo No @php echo str_repeat('&nbsp;',3); @endphp:</strong>
                                                <strong>{{ $invoice->memo_no }}</strong></h6>
                                            <h6><strong>Sold By @php echo str_repeat('&nbsp;',6); @endphp:</strong>
                                                <strong>{{ Auth::user()->name }}</strong></h6>
                                            @if ($invoice_setting->do_no)
                                                <h6><strong>DO No: @php echo str_repeat('&nbsp;',6); @endphp:</strong>
                                                    <strong>{{ $invoice->do_no }}</strong></h6>
                                            @endif
                                            @if ($invoice_setting->lpo_no)
                                                <h6><strong>LPO No @php echo str_repeat('&nbsp;',6); @endphp:</strong>
                                                    <strong>{{ $invoice->lpo_no }}</strong></h6>
                                            @endif
                                        </div>
                                    </div>
                                    <br />
                                ...
                                @if ($invoice_setting->transaction)
                                    <div
                                        style="width: 500px; margin: 0 auto;padding: 10px; position: relative; left: 47px;">
                                ...
                                <div class="col-md-12 heading" style="position:absolute; left: 0px;>
                                    <table>
                                     <tr class=" inv_item_row">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js"
    ...
    <script>
        ...
        $(document).ready(function() {
            var datatable = $('#SaleReturnListTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('data.sale-return-list-table') }}",
                columns: [{
                        title: 'SL',
                        data: 'id'
                    },
