...
<div>
    <x-slot name="title">Requisition</x-slot>
    <x-slot name="header">Requisition</x-slot>
    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title mb-3">New Requisition</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                            <div class="text-sm-right">
                                <a href="{{ route('inventory.requisition-list') }}"> <button type="button"
                                        style="float: right;"
                                        class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"
                                        data-toggle="modal" data-target=".bd-example-modal-lg"><i
                                            class="mdi mdi-plus mr-1"></i>Requisition List</button></a>
                            </div>
                        </div>
                        <div class="col-md-12 mb-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-2" style="margin-top: 25px;">
                                    <button class="btn btn-info btn-round  CustomerAddButton" type="button"
                                    wire:click="ItemModal" title="Add Item/Product"><i class="fas fa-plus"></i> Add<button>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            class="form-label">Product/Material</label>
                                ...
                                <tbody>
                                    @foreach ($orderItemList as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if (isset($item['vat']['rate_percent'])) {{ $item['vat']['rate_percent'] }} @endif
                                            </td>
                                            <td>
                                                {{ $item_subtotal[$key] }}
                                            </td>
                                            {{-- <td>
                                            <input type="text" class="form-control" wire:model.debounce.500ms="item_batch_no.{{$key}}" placeholder="Batch No."/>
                                        </td>
                                        <td>
                                            <input type="date" wire:model.debounce.500ms="item_expired_date.{{$key}}" class="form-control"/>
                                        </td> --}}
                                            <td>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <div wire:ignore class="form-group">
                        ...
                        <select class="form-control form-select select2" wire:model.lazy="contact_id" id="contact_id"
                            name="contact_id" style="width:100%;">
                ...
                <div class="col-md-1 mt-4 ">
                    <button class="btn btn-outline-primary btn-round ml-2 CustomerAddButton" wire:click="SupplierModal"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="" wire:model.debounce.150ms="discount_amount" style="min-width:100px;"
                                    type="number" class="form-control purchaseCalUpdate rounded" placeholder="Discount">
                            </td>
                            <td>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary float-right"
                        wire:click="RequisitionSave">Submit</button>
                </div>
            </div>
        </div>
    </div>
