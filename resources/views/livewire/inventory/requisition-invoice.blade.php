    ...
    <div id="invoice_page">
        <div class="header">
           <div style="overflow:hidden;">
              ...
              <div style="float:right;width: 25%; position: relative; bottom: 25px;">
                 {{-- <h3 style="color:red;font-weight:bold;margin-left:0px;margin-top:0px;font-size:20px;">{{$invoice->payment_status}}</h3> --}}
                 <h6 style="margin-top:50px;font-weight:bold;font-size:20px;color:lightskyblue">Requisition</h6>
              ...
              <tbody>
                ...
                @foreach ($invoice->StockItemInvoice as $detail)
                 ...
                 <tr>
                    ...
                    <td align="right" style="font-weight:bold;border:1px groove">{{$amount}}</td>
                    <td align="right" style="font-weight:bold;border:1px groove">{{$texable_value}}</td>
                    <td align="right" style="font-weight:bold;border:1px groove">{{$total_vat}}</td>
                 ...
                 <tr class="inv_item_row">
                    ...
                    <td colspan="2" align="right" style="font-weight:bold;">@if($invoice){{$invoice->amount_to_pay}}@endif</td>
                 </tr>
