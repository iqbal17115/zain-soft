...
<div>
        ...
        <div class="header">
            <div style="overflow:hidden;">
                <div style="float:left;margin-top:0px;width: 74%;">
                    <div class="row">
                        <div style="float:left;width: 25%;">
                            <span><img height=60px; width=100px; src="@if ($invoice_setting){{ asset('storage/photo/' . $invoice_setting->logo) }}@endif" alt=""></span>
                        </div>
                    ...
                    <h6><strong>Contact Person @php echo str_repeat('&nbsp;',6); @endphp:</strong><strong>@if ($invoice) {{ $invoice->Contact->business_name }}@endif</strong>
                    </h6>
                ...
                <div style="float:right;width: 25%; position: relative; bottom: 50px;">
                    <h3 style="color:red;font-weight:bold;margin-left:0px;margin-top:60px;font-size:20px;">
                        {{ $invoice->payment_status }}
                    </h3>
                    <h6 style="margin:0px;font-weight:bold;font-size:20px;margin-top:20px;color:lightskyblue">Purchase
                        Invoice</h6>
                    ...
                    <tbody>
                        @foreach ($invoice->InvoicePaidAmount as $accountManager)
                            <tr class="inv_item_row">
                                ...
                                <td align="center" style="border:1px solid black">
                                    @if ($currencySymbol) {{ $currencySymbol->symbol }} @endif{{ $accountManager->amount }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="col-md-12 heading">
            <div class="col-md-8" style="position:absolute">
                <table style="position: relative; top: 10px;">
                    <tr class="inv_item_row">
                        <strong>
                            <td>Amount Chargeable (In Words): {{ $numberToWordTotal }}</td>
                        </strong>
                    </tr>
                    {{-- <tr>
    ...
    <div class="col-md-12" style="position: relative; top: 551px; left: 1216px;">
        <a href="{{ route('inventory.purchase-list') }}">
            <button type="button" style="background-color: rgb(5 100 5); color:honeydew;"
                class="btn btn-success">Purchase List</button>
        </a>
    </div>
</div>
@push('scripts')
