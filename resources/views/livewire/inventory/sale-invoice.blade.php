...
<div>
    ...
    <div id="invoice_page">
        <div class="header">
            <div style="overflow:hidden;">
                <div style="float:left;margin-top:0px;width: 74%;">
                    ...
                    {{-- <h6><strong>Place of customer @php echo str_repeat('&nbsp;', 3); @endphp:</strong> <strong>{{ $invoice->Contact->division }}{{ $invoice->Contact->country }}</strong></h6> --}}
                    <!--h6>Delivery By &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; Nazmul</h6-->
                </div>
                <div style="float:right;width: 25%;" class="sale-purchase-position-one">
                    <h3 style="color:red;font-weight:bold;margin-left:0px;margin-top:20px;font-size:20px;">
        ...
        <div class="col-md-12 heading">
            <div class="col-md-12" style="position:relative; right: top: 17px;">
                <table>
                    <tr class="inv_item_row">
        ...
        <div class="col-md-6">
            <div style="float:left;margin-top:30px;">
                ...
                <p>
                    ...
                    Powered by: <a href="https://mathemacia.com/" target="_blank">Marthemacia</a>
                </p>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="col-md-12" style="position: relative; top: 583px; left: 1242px;">
        <a href="{{ route('inventory.sale-list') }}">
            <button type="button" style="background-color: rgb(5 100 5); color:honeydew;"
                class="btn btn-success">Sale List</button>
        </a>
    </div>
</div>
@push('scripts')
