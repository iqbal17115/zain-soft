...
<div>
    ...
    <x-slot name="header">PURCHASE RETURN</x-slot>
    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title mb-3">Purchase Return</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="text-sm-right">
                                <a href="{{ route('inventory.purchase-return-list') }}">
                                    <button type="button" style="float: right;" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" data-toggle="modal" data-target=".bd-example-modal-lg">
                                        <i class="mdi mdi-plus mr-1"></i>Purchase Return List
                                    </button>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="example-search-input" class="form-label">Purchase Date</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Purchase Code/Invoice No</label>
                                        <input type="text" name="" wire:keydown.enter="GetData($event.target.value)" placeholder="Purchase Code/Invoice No">
                    ...
                    <div class="row mb-2">
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered" id="" style="width:100%">
                                ...
                                <tbody>
                                    @if($PurchaseInvoice)
                                    @foreach ($PurchaseInvoice->StockManager as $key => $item)
                                    <tr>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Purchase Return Subtotal</th>
                            <th>Purchase Return Vat</th>
