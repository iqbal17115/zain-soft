                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title mb-3 size">Category</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-8" >
                            <div class="text-sm-right model">
                                <button type="button" style="float: right;" class="model btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" wire:click="CategoryModal">
                                    <i class="mdi mdi-plus mr-1"></i>New Category
                                </button>
                            </div>
                        </div>
                        <div wire:ignore class="table-responsive">
                            <table class="display table table-striped table-bordered" id="CategoryTable" style="width:100%"></table>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <input class="form-control" wire:model.lazy='name' type="text" placeholder="Enter Category Name" />
...
<script>
    ...
    $(document).ready(function () {
        ...
        var datatable = $('#CategoryTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{route('data.category-table')}}",
            columns: [
                {
                    title: 'SL',
                    data:  'id'
