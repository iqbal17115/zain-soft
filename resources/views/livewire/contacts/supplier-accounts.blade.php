...
@endpush
<div>
    <x-slot name="title">SUPPLIER ACCOUNTS</x-slot>
    <x-slot name="header">SUPPLIER ACCOUNTS</x-slot>
    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title mb-3">Supplier Accounts</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                            <div class="text-sm-right model">
                                <button type="button" style="float: right;"
                                    ...
                                    wire:click="SupplierModal">
                                    <i class="mdi mdi-plus mr-1"></i> New Supplier
                                </button>
                            </div>
                        </div>
                        <div wire:ignore class="table-responsive">
                            <table class="display table table-striped table-bordered" id="SupplierTable"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="@if ($vat_reg_type == 'Registered') col-md-6 @else col-md-6 @endif form-group mb-3">
                                ...
                                @error('vat_reg_type') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                            @if($vat_reg_type=="Registered")
                            <div class="col-md-6 form-group mb-3">
                                <label>Registration Date</label>
                                <input class="form-control" wire:model.lazy="vat_reg_date" type="date"/>
                                @error('vat_reg_date') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                            @endif
...
@push('scripts')
    <script>
        function callEdit(id) {
            @this.call('SupplierAccountsEdit', id);
        }

        function callDelete(id) {
            @this.call('SupplierAccountsDelete', id);
        }
        ...
        $(document).ready(function() {
            ...
            var datatable = $('#SupplierTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('data.supplier-table') }}",
                columns: [{
                        title: 'SL',
                        data: 'id'
                    },
