...
<div>
    ...
    <x-slot name="header">STAFF ACCOUNTS</x-slot>
    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title mb-3 size">Staff Accounts</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                            <div class="text-sm-right model">
                                <button type="button" style="float: right;"
                                    ...
                                    wire:click="StaffModal">
                                    <i class="mdi mdi-plus mr-1"></i> New Staff
                                </button>
                            </div>
                        </div>
                        <div wire:ignore class="table-responsive">
                            <table class="display table table-striped table-bordered" id="StaffTable"
    ...
    <div wire:ignore.self class="modal fade" id="StaffModal" tabindex="-1" role="dialog"
        aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Staff Accounts</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="StaffSave">
...
@push('scripts')
    <script>
        function callEdit(id) {
            @this.call('StaffAccountsEdit', id);
        }

        function callDelete(id) {
            @this.call('StaffAccountsDelete', id);
        }
