                        ...
                        <div class="col-sm-12">
                            <div class="search-box mr-2  d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title" id="header-text-design">Purchase Report</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="table-responsive">
                <table id="datatable-buttons" class="table table-striped table-bordered nowrap"
                    ...
                    <tbody>
                        ...
                        $total_vat = 0;
                        @endphp
                        @foreach ($this->dateFilter($purchases) as $purchase)
                        <tr>
                            ...
                            <td>
                                {{ $purchase->subtotal }}
                                <?php $subTotal += $purchase->subtotal; ?>
                            </td>
                            <td>
                                {{ $purchase->discount }}
                            ...
                            <td>
                                {{ $purchase->shipping_charge }}
                                <?php $shipping_charge += $purchase->shipping_charge; ?>
                            </td>
                            <td>
                                {{ $purchase->total_vat }}
                                <?php $total_vat += $purchase->total_vat; ?>
                            </td>
                            <td>
                                {{ $purchase->amount_to_pay }}
                                <?php $grand_total += $purchase->amount_to_pay; ?>
                            </td>
                            <td>
                                {{ $purchase->paid_amount }}
                                <?php $paid_amount += $purchase->paid_amount; ?>

                            </td>
                            <td>
                                {{ $purchase->due_amount }}
                                <?php $due += $purchase->due_amount; ?>
                            </td>
                            <td>
                                @if ($purchase->Branch)
