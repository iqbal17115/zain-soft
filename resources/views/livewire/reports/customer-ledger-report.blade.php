...
<div>
    <x-slot name="title">Customer LEDGER REPORT</x-slot>
    <x-slot name="header">Customer LEDGER REPORT</x-slot>
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <div class="search-box mr-2  d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title" id="header-text-design">Customer Leadger Report</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered nowrap"
                    ...
                    <tbody>
                        <tr>
                            ...
                            $crOpening = $this->openingDateFilter($Contact->SaleInvoice)->sum('amount_to_pay');
                        ...
                        $crAmount = 0;
                        @endphp
                        @foreach ($this->dateFilter($Contact->SaleInvoice) as $crItem)
                        @php
                                ...
                                <div style="overflow:hidden;">
                                    <div style="float:left;margin-top:0px;width: 74%;">
                                        ...
                                        <h6><strong>@if($invoice->type=="Sales") Customer
                                                @elseif($invoice->type=="Purchase") Supplier @endif Name
                                    ...
                                    <div style="float:right;width: 25%;">
                                        ...
                                        <h6><strong>Invoice No @php echo str_repeat('&nbsp;', 1);
                            ...
                            <div class="header">
                                <div style="overflow:hidden;">
                                    <div style="float:left;margin-top:0px;width: 74%;">
                                        ...
                                        <h6>Contact Person &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp; @if($invoice)
                                            {{$invoice->Contact->business_name}}@endif</h6>
                                        <h6>Telephone
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                                            @if($invoice) {{$invoice->Contact->telephone}}@endif</h6>
                                        <h6>Mobile&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                                            @if($invoice) {{$invoice->Contact->mobile}} @endif</h6>
                                        <h6>TRN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                                            @if($invoice) {{$invoice->Contact->trn_no}} @endif</h6>
                                        <h6>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;@if($invoice)
                                            {{$invoice->Contact->email}} @endif</h6>
                                        <h6>Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;@if($invoice)
                                            {{$invoice->Contact->address}} @endif</h6>
                                    </div>
                                    <div style="float:right;width: 25%;">
                                        <h3
                                        ...
                                        <h6><strong>Invoice No
                                                &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</strong><strong>{{$invoice->code}}</strong>
                                        </h6>
                                        <h6>Date
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
                                            {{date("Y/m/d")}}</h6>
                                        <h6>Chalan No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
                                            {{$invoice->chalan_no}}</h6>
                                        <h6>Memo No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            {{$invoice->memo_no}}</h6>
                                        <h6>Sold By
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border:1px solid black">
                                                            @if($manager->dr_account_id){{ $manager->ChartOfAccountDr->name
                                                            }}@else{{ $manager->ChartOfAccountCr->name }}@endif</td>
