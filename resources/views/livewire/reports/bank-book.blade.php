...
<div>
    <x-slot name="title">BANK BOOK REPORT</x-slot>
    <x-slot name="header">BANK BOOK REPORT</x-slot>
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <div class="search-box mr-2  d-inline-block">
                                <div class="position-relative">
                                    <h4 class="card-title" id="header-text-design">Bank Book Report</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div wire:ignore class="col-md-3">
                            <div class="form-group">
                                <label for="basicpill-firstname-input">Select Cash Bank</label>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($crItem->Invoice)
                                <button class="btn" wire:click="InvoiceModal({{$crItem->Invoice->id}})">
