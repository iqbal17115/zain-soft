            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="purchase_detail_report_table" class="table table-striped table-bordered nowrap"
...
<script>
    $(document).ready(function(){
		...
		$('#purchase_detail_report_table').DataTable({
			processing: true,
			responsive: true,
			serverSide: true,
			ajax: {
				url: "{{ route('reports.purchase-detail-report-data') }}",
				type: 'GET',
				cache: false,
				data : function ( d ) {
			...
			{ title: 'Purchase Price(AED)', data: 'purchase_price', class: "purchase_price", name: 'purchase_price' },
		...
		$(document).on('change','.updateTable',function () {
			$('#purchase_detail_report_table').DataTable().draw(true);
		});
	});
</script>
@endsection
