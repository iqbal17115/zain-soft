...
<script>
    $(document).ready(function(){
		...
		$('#purchase_report_table').DataTable({
			...
			serverSide: true,
			ajax: {
				url: "{{ route('reports.purchase-report-data') }}",
				type: 'GET',
				cache: false,
				data : function ( d ) {
			...
			// { title: 'Sub Total(AED)', data: 'subtotal', name: 'subtotal' },
			// { title: 'Discount(AED)', data: 'discount', name: 'discount' },
			// { title: 'Shipping Charge(AED)', data: 'shipping_charge', class: "shipping_charge", name: 'shipping_charge' },
			// { title: 'Vat Total(AED)', data: 'total_vat', class: "total_vat", name: 'total_vat' },
			{ title: 'Total(AED)', data: 'amount_to_pay', class: "amount_to_pay", name: 'amount_to_pay' },
			{ title: 'Paid(AED)', data: 'paid_amount', class: "paid_amount", name: 'paid_amount' },
			{ title: 'Due(AED)', data: 'due_amount', class: "due_amount", name: 'due_amount' },
			{ title: 'Due Date', data: 'due_date', class: "due_date", name: 'due_date' },
